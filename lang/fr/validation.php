...
return [
    ...
    */
    ...
    'lte' => [
        ...
        'string' => 'Le champ :attribute doit contenir moins de ou égal à :value caractères.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        "identity issued at" => "identité délivrée à",
        "identity issued in" => "identité délivrée à",
        "license number" => "numéro de licence",
        "license issued at" => "licence délivrée à",
        "license issued in" => "licence délivrée à",
        "subscribe" => "abonnement",
        "logo" => "logo",
        "ice number" => "numéro ICE",
        "consumable name" => "nom du consommable",
        "unit of measurement" => "unité de mesure",
        "recurrence amount" => "montant de la récurrence",
        ...
        "date" => "date",
        "reasons" => "raisons",
        "registration type" => "type d'immatriculation",
        ...
        "insurance issued at" => "assurance délivrée à",
